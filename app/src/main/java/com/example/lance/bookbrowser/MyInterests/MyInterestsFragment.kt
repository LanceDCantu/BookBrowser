...
class MyInterestsFragment : Fragment() {
    ...
    lateinit var mAdapter: CustomInterestsAdapter
    ...
    override fun onCreateView(
        ...
        mAdapter = CustomInterestsAdapter(
            mDatasetTitle,
            mDatasetAuthor,
            mDatasetPrice,
            mDatasetSeller
    ...
    private fun initDataset()
    {
        ...
        users_ref.child("lancedcantu@yahoo!com/" + "my_interests/").addValueEventListener(menuListener)
    }
